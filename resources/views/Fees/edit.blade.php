                    ...
                    <form action="{{route('Fees.update','test')}}" method="post" autocomplete="off">
                        ...
                        <div class="form-row">
                            <div class="form-group col">
                                ...
                                <input type="text" value="{{$fee->getTranslation('tittle','ar')}}" name="title_ar" class="form-control">
                                <input type="hidden" value="{{$fee->id}}" name="id" class="form-control">
                            </div>

                            <div class="form-group col">
                                <label for="inputEmail4">الاسم باللغة الانجليزية</label>
                                <input type="text" value="{{$fee->getTranslation('tittle','en')}}" name="title_en" class="form-control">
                            </div>
