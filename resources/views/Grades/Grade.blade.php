                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="{{route('Grades.update',['Grade'=>$Grade->id])}}" method="post">
                                                ...
                                                <div class="form-group">
                                                    <label for="exampleFormControlTextarea1">{{ trans('Grades.Notes') }}Ar
                                                        :</label>
                                                ...
                                                <div class="form-group">
                                                    <label for="exampleFormControlTextarea1">{{ trans('Grades.Notes') }}
                                                        :</label>
                                                    <textarea class="form-control" name="Notes_en" id="exampleFormControlTextarea1" rows="3">{{ $Grade->Notes_en }}</textarea>
                                                </div>
                                                <br><br>
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('Grades.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <label for="exampleFormControlTextarea2"> {{ trans('Grades.Notes') }} Ar</label>
